...
/**
 * Local plugin "country_category" - Enrolment form
 *
...
namespace local_country_category;

use context_system;
use core_course_category;
use core_course_editcategory_form;
defined('MOODLE_INTERNAL') || die();
require_once($CFG->libdir.'/formslib.php');


/**
 * Class country_category_form
 * @package local_country_category
 * @copyright 2020 Brain station 23 ltd. <brainstaion-23.com>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class country_category_form extends core_course_editcategory_form {
...
//        $mform->addElement('select', 'parent', get_string('parentcategory'), $options);
        ...
        $mform->addElement('text', 'name', get_string('categoryname','local_country_category'), array('size' => '30'));
        ...
        $mform->addElement('select', 'country', get_string('country_category_lang','local_country_category'), $langs,['multiple']);
        $mform->addRule('country', get_string('required'), 'required', null);
